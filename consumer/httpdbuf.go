...
func init() {
	shared.RuntimeType.Register(HttpdBuf{})
}

// Configure initializes this consumer with values from a plugin config.
func (cons *HttpdBuf) Configure(conf core.PluginConfig) error {
...
func (cons *HttpdBuf) requestHandler(resp http.ResponseWriter, req *http.Request) {
...
func (cons HttpdBuf) Consume(workers *sync.WaitGroup) {
