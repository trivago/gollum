...
func TestAccessLogFormat1(t *testing.T) {
	...
	expectMapping(t, parsedMsg, "clientIP2", "-")
	...
	expectMapping(t, parsedMsg, "metrics", "0 0 1 6 0 0 1")
...
func TestAccessLogFormat2(t *testing.T) {
	...
	expectMapping(t, parsedMsg, "metrics", "- - - - - - -")
...
func TestAccessLogFormat3(t *testing.T) {
	...
	expectMapping(t, parsedMsg, "serverIP", "10.1.2.44")
	expectMapping(t, parsedMsg, "serverName", "www.trivago.de")
	expectMapping(t, parsedMsg, "clientIP", "79.236.28.139, 10.1.2.81")
	expectMapping(t, parsedMsg, "clientIP2", "-")
	expectMapping(t, parsedMsg, "@timestamp", "2015-02-12T14:41:15Z")
	expectMapping(t, parsedMsg, "method", "GET")
	...
	expectMapping(t, parsedMsg, "protocol", "HTTP/1.1")
	expectMapping(t, parsedMsg, "resultCode", "200")
	expectMapping(t, parsedMsg, "requestSize", "537")
	expectMapping(t, parsedMsg, "responseSize", "99233")
	expectMapping(t, parsedMsg, "command", "PriceSearchBundle_suggest")
	expectMapping(t, parsedMsg, "metrics", "0 0 1 6 0 0 0")
	...
	expectMapping(t, parsedMsg, "session", "VNytewoBAiwAAUladOYAAAAK")
